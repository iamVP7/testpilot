...
storiesOf('UpgradeWarning', module)
  ...
  .add('developing test pilot', () => <UpgradeWarningPage {...baseProps} host={'example.com:8000'} />)
  .add('unapproved hostname', () => <UpgradeWarningPage {...baseProps} host={'cyber.hell.scape'} />);
